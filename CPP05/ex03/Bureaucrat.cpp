...
/*   Updated: 2025/12/28 17:26:36 by slakhrou         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	Bureaucrat::signForm(AForm& form)
{
	...
	{
		std::cout<<this->getName()<<" couldn’t sign "<<form.getName()<<" because your "<<e.what()
		<<"for this form."<<std::endl;
	}
}
...
void Bureaucrat::executeForm(AForm const & form) const
{
	...
	{
		std::cout<<"Error couldn't execute form : "<<e.what()<<std::endl;
	}
}
